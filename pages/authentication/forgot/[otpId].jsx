...
export default function OtpPage({ otpID, urlID }) {
  ...
  async function handleSubmit() {
    ...
    setLoading(false);
    await axios.post('/api/auth/forgot/otpMatch', otpData)
    .then((res) => {
      alert(res.data.message);
      const url = urlID + res.data.id;
      router.push(`/authentication/forgot/password/${url}`);
    }).catch((error) => {
